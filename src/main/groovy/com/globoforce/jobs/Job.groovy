...
class Job {
    ...
    static void createPipeline(pipelineJob, org.testng.xml.XmlSuite currentSuite, String suiteName) {
        pipelineJob.with {
			...
			throw new RuntimeException("Undefined suite test type: " + suiteName);
                ...
                configure addExtensibleChoice('repository', "gc_GIT_REPOSITORY", "Select a GitHub Testing Repository to run against", "git@github.com:qaprosoft/globoforce-mobile.git")
            ...
            definition {
                cpsScm {
                    ...
                    scriptPath('src/main/groovy/com/globoforce/pipelines/JenkinsFile')
                }
            }
        }
    }
    ...
    static void createRegressionPipeline(pipelineJob, suiteName, List customFields) {
        pipelineJob.with {
            ...
            configure addExtensibleChoice('repository', "repositories", "Select a GitHub Testing Repository to run against", "git@github.com:qaprosoft/globoforce-mobile.git")
            configure addExtensibleChoice('branch', "gc_GIT_BRANCH", "Select a GitHub Testing Repository Branch to run against", "master")
            parameters {
            ...
            definition {
                cpsScm {
                    ...
                    scriptPath('src/main/groovy/com/globoforce/pipelines/JenkinsFilePipeline')
                }
            }
        }
    }
